...
- 当前阶段：`E5`（热键配置 + 收尾；功能落地，等待 Codex 最终验收 / PROJECT COMPLETE 判定）
- 已归档轨道：`v1-baseline`
- 轨道内已通过阶段：E1、E2、E3、E4（均 2026-04-24）
...
- ✅ 7 条 E5 smoke 覆盖（预设完整性 / getHotkey 默认值 / round-trip 所有预设 / 非法值 fallback）
